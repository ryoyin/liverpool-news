              ...
              <ul class="matches custom-list">
                ...
                <li class="match">
                  ...
                  <div class="team right text-right">
                    ...
                    <img src="storage/resources/img/team-upcoming4.png" alt="">
                  </div>
                </li>
                <li class="match">
                  <div class="team text-left">
                    <img src="storage/resources/img/team-upcoming5.png" alt=""><span>Xavier United</span>
                  </div>
                  <div class="schedule">
                    <span class="team-name">Sao Paolo</span>
                    <span class="time">30 May 23:00</span>
                ...
                <li class="match">
                  <div class="team text-left">
                    <img src="storage/resources/img/team-upcoming7.png" alt=""><span>Azkalz FC</span>
                  </div>
                  <div class="schedule">
                    <span class="team-name">Sao Paolo</span>
                    <span class="time">30 May 23:00</span>
                  ...
                  <div class="team right text-right">
                    ...
                    <img src="storage/resources/img/team-upcoming8.png" alt="">
                  </div>
                </li>
                <li class="match">
                  <div class="team text-left">
...
{{-- 
          ...
          <div class="tab-pane fade" id="juvenile-matches">
            ...
            <div class="result col-lg-6 col-lg-offset-0 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 clearfix">
              ...
              <div class="team">
                <figure>
                  <img src="storage/resources/img/team1.jpg" alt="" class="team-background">
                  <img src="storage/resources/img/team1-logo.png" alt="" class="team-logo">
                  <figcaption>
                    FC Lorem
                  </figcaption>
      ...
      <div class="teams-frame col-lg-12">
        ...
        <div class="tab-pane fade active in" id="senior-team">
          ...
          <div class="team-players">
            ...
            <div class="player-profile">
              <img src="storage/resources/img/team-player7.jpg" alt="" class="thumbnail">
              <span class="number">11</span>
              <span class="name">Ican Ivanovich</span>
            </div>
            <div class="player-profile">
              <img src="storage/resources/img/team-player8.jpg" alt="" class="thumbnail">
              <span class="number">14</span>
              <span class="name">Hong Gildong</span>
            </div>
            <div class="player-profile">
              <img src="storage/resources/img/team-player9.jpg" alt="" class="thumbnail">
              <span class="number">18</span>
              <span class="name">Hong Gildong</span>
            </div>
            <div class="player-profile">
              <img src="storage/resources/img/team-player10.jpg" alt="" class="thumbnail">
              <span class="number">19</span>
              <span class="name">Ola Nordmann</span>
            </div>
            <div class="player-profile">
              <img src="storage/resources/img/team-player11.jpg" alt="" class="thumbnail">
